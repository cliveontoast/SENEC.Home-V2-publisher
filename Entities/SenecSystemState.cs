...
namespace Entities
{
    [DebuggerDisplay("System state {EnglishName}")]
    public class SenecSystemState : SenecDecimal
    {
        public SenecSystemState(SenecDecimal senecDecimal) : this(senecDecimal.Type, senecDecimal.Value)
        {
        }
        public SenecSystemState(int type, decimal? value = null) : base(type, value)
        {
        }

        public string EnglishName => Value switch
        {
            0 => "INITIALSTATE",
